            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                <div className="flex items-center mb-3">
                  ...
                  <a href="https://leetcode.com/u/Mausumighadei/" target="_blank" rel="noopener noreferrer">
              ...
              >
                <div className="flex items-center mb-3">
                  ...
                  <a href="https://www.geeksforgeeks.org/user/mausuminfz8/" target="_blank" rel="noopener noreferrer">
              ...
              >
                <div className="flex items-center mb-3">
                  ...
                  <a href="https://www.codechef.com/users/mausumighadei" target="_blank" rel="noopener noreferrer">
