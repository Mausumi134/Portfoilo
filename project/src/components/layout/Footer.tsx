    ...
    <footer className="bg-gray-900 text-white pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-gray-400">
                ...
                <a href="mailto:mausumighadei@gmail.com" className="hover:text-primary-400 transition-colors">
                  mausumighadei@gmail.com
                </a>
              </li>
              <li className="flex items-center text-gray-400">
                <Phone className="h-5 w-5 mr-2" />
                <a href="tel:+916372606980" className="hover:text-primary-400 transition-colors">
                  +91 63726 06980
                </a>
              </li>
              <li className="flex items-center text-gray-400">
                ...
                <a 
                  href="https://linkedin.com/in/mausumi-ghadei-006466229" 
                  target="_blank" 
                  rel="noopener noreferrer"
              ...
              <li className="flex items-center text-gray-400">
                ...
                <a 
                  href="https://github.com/Mausumi134" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="hover:text-primary-400 transition-colors"
                >
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>© {currentYear} Mausumi Ghadei. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
